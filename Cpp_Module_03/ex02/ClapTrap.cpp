...
ClapTrap::ClapTrap(std::string name): name(name), hitPoints(10), energyPoints(10), attackDamage(0) {
    std::cout << "ClapTrap Constructor for the name " << this->name << " called\n";
    this->name = name;
}
/*Copy Constructor*/
...
void    ClapTrap::beRepaired(unsigned int amount) {
    ...
    {
        this->hitPoints += amount;
        std::cout << BOLDGREEN << "ClapTrap " << this->name << " repaired itself and gained "
        << amount << " of points, he now has " << this->hitPoints << " hit points.\n" << RESET;
        this->energyPoints--;
    }
    else
    {
